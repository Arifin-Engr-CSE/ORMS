...
using ORMS.Data;
using ORMS.Models;
using ORMS.Models.ViewModels;
using ORMS.Utility;

namespace ORMS.Areas.Customer.Controllers
{
    [Area("Customer")]
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> OrderReady(int? OrderId)
        {
            ...
            await _emailSender.SendEmailAsync(_db.Users.FirstOrDefault(u => u.Id == orderHeader.UserId).Email,
                                                "ORMS - Order Ready For Pickup " + orderHeader.Id.ToString(),
        ...
        public async Task<IActionResult> OrderCancel(int? OrderId)
        {
            ...
            await _emailSender.SendEmailAsync(_db.Users.FirstOrDefault(u => u.Id == orderHeader.UserId).Email,
                                                "ORMS - Order Canceled " + orderHeader.Id.ToString(),
        ...
        public async Task<IActionResult> OrderPickupPost(int orderId)
        {
            ...
            await _emailSender.SendEmailAsync(_db.Users.FirstOrDefault(u => u.Id == orderHeader.UserId).Email,
                                    "ORMS - Order Completed " + orderHeader.Id.ToString(),
